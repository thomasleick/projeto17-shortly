...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.urls_id_seq' :: regclass);
...
VALUES
    (
        2,
        'hGbpt5',
        'https://www.figma.com/file/DWg9233KR2GS6RLvfZRwyd/Shortly?type=design&node-id=1-2&t=VGKJ6JmBLCtaHMdK-0',
        19,
        1,
        '2023-05-18 19:34:54.852723'
    );
...
VALUES
    (
        3,
        '5qTXt8',
        'https://scontent.fcgh10-1.fna.fbcdn.net/v/t39.30808-6/296381730_383236407247843_4149487714577975930_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeFEjPMWbRC_-iXv91XJCiHrj5KEHyD-BXCPkoQfIP4FcNjvcRbwRDtmjAYwHxZqGhAH2q3xNh6vMtVh2hj2Bg5l&_nc_ohc=ykhvKq8-2e0AX9r4cSM&_nc_ht=scontent.fcgh10-1.fna&oh=00_AfBk8HjUdeyL8i3ZF22VRpvdam5fppTA8gH-Q503YOSEmg&oe=646ADC0E',
        2,
        1,
        '2023-05-18 22:04:55.94238'
    );
...
VALUES
    (
        ...
        'thomasaleick@gmail.com',
        '$2b$10$v0icviy/gTSVgVF7owNci.WTR.WaqlJD8wgUFBx0CC7AzT7Emkdza',
        '2023-05-16 12:22:15.708566',
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjg0NDY2NTg0LCJleHAiOjE3NzA4NjY1ODR9.yFx3XAquzYZr9CL6GlmvEBBsQgBbOutsBSFQb-S1mVM'
    );
...
VALUES
    (
        2,
        'Thomas Andrioli Leick',
        '12thomasaleick@gmail.com',
        '$2b$10$cMrOIJWCXYTH8XA2gDBN8OvaR11WD12y10AdJtzGXZA8S7DDr2Vj2',
        '2023-05-17 20:12:44.059986',
        NULL
    );
...
--
SELECT
    pg_catalog.setval('public.urls_id_seq', 6, true);
...
ALTER TABLE
    ONLY public.urls
ADD
    CONSTRAINT urls_userid_fkey FOREIGN KEY ("userId") REFERENCES public.users(id);
